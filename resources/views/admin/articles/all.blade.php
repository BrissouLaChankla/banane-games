                ...
                <div class="col-md-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            ...
                            <a target="_blank" href="{{route('show-article', ['slug' => $article->slug])}}" class="btn btn-warning text-white d-flex align-items-center">
                                <span class="material-symbols-rounded">
                                    visibility
                                </span>
                            </a>
                            <a href="{{route('show-edit-article', ['slug' => $article->slug])}}" class="btn btn-primary d-flex align-items-center">
                                <span class="material-symbols-rounded">
                                    edit
                                </span>
                            </a>
