                                ...
                                <tr>
                                    <td align="center" valign="center">
                                        <div style="background-color:#C90A4C; text-align:center" align="center">
                                            <br>
                                            <br>
                                                <img src="{{asset('img/logo_nanagames.webp')}}" height="80" alt="Logo Nanagames">
                                            <br>
                                            <br>
                                        </div>
                                    </td>
                            ...
                            <table border="0" cellpadding="20" cellspacing="0" width="100%" id="emailFooter">
                                <tr>
                                    <td align="center" style="border-top:1px solid gray" valign="top">
                                        ...
                                        <img src="{{asset('img/mister-nanaba/nanathumb.webp')}}" height="80" alt="Nanathumb Nanagames">
                                    </td>
                                </tr>
                            </table>
                        </td>
