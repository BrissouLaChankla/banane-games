<footer id="footer" class="py-5 bg-primary text-white mt-10 text-lg-start">
    <div class="container px-5 px-lg-0">
        <span class="nanagames text-secondary font-title">BananeGames</span>
        <div class="row mt-3 mt-lg-8">
            <div class="col-lg-3">
                <div class="mb-4">
                    <h3 class="mb-lg-5 mb-2 h4">Découvrez-nous</h3>
                    <div class="d-flex flex-column align-items-start">
                        <a href="https://brice-eliasse.com/" target="_blank">Brice Eliasse</a>
                        <a href="#" target="_blank">Rémi Vialle</a>
                        <a href="#" target="_blank">Sarah Amar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <a href="#" target="_blank">Nous rejoindre</a>
                    </div>
                </div>
            </div>
